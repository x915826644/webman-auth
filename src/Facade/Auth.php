...
namespace Jody\WebmanAuth\Facade;

/**
 * Class Auth
 * @package Jody\WebmanAuth\Facade
 * @see \Jody\WebmanAuth\Auth
 * @mixin \Jody\WebmanAuth\Auth
...
class Auth
{
    ...
    {
        if (!static::$_instance) {
            static::$_instance = new \Jody\WebmanAuth\Auth();
        }
